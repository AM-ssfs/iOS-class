...
var shapesArray = ["circle", "square", "triangle", "diamond", "hexagon"]

var colorsArray = ["blue", "purple", "orange", "gold", "red"]

var colorfulShapes = [String : [String]]()

colorfulShapes["shapes"] = shapesArray
