...
greeting(greeting: "Hi", name: "Aden")
greeting(greeting: nil, name: "Aden")
...
var abc = Car(make: "Voeltswaegon", model: "extra delude anniversary edition", year: 2002)
print(abc.make)
/*:
